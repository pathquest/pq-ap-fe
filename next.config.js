...
const nextConfig = {
  ...
  env: {
    ...
    CLOUD_CONFIGURATION_GOOGLEDRIVE_CLIENTID: process.env.CLOUD_CONFIGURATION_GOOGLEDRIVE_CLIENTID,
    CLOUD_CONFIGURATION_GOOGLEDRIVE_REDIRECTURI: process.env.CLOUD_CONFIGURATION_GOOGLEDRIVE_REDIRECTURI,
    CLOUD_CONFIGURATION_GOOGLEDRIVE_CLIENTSE: process.env.CLOUD_CONFIGURATION_GOOGLEDRIVE_CLIENTSE,
    CLOUD_CONFIGURATION_DROPBOX_CLIENTID: process.env.CLOUD_CONFIGURATION_DROPBOX_CLIENTID,
    CLOUD_CONFIGURATION_DROPBOX_AUTHURL: process.env.CLOUD_CONFIGURATION_DROPBOX_AUTHURL,
    CLOUD_CONFIGURATION_DROPBOX_REDIRECTURL: process.env.CLOUD_CONFIGURATION_DROPBOX_REDIRECTURL,
    API_PQBI: process.env.API_PQBI
  },
  images: {
