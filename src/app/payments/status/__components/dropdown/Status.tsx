    ...
    return (
        <div className='relative'
            ...
            <div className='flex h-10 items-center px-1' tabIndex={-1}>
                <label
                    className={`flex font-proxima cursor-pointer select-none items-start bg-transparent outline-none ${isOpen ? "text-primary placeholder:text-primary" : "text-black placeholder:text-black"} text-base placeholder:text-base placeholder:font-bold font-bold cursor-pointer`}
                    onClick={handleInput}>
